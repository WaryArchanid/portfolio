      ...
      <div className="container">
        <div className="border-t border-white/15 py-6 text-sm flex flex-col items-center md:flex-row md:justify-between gap-8">
          ...
          <nav className="flex flex-col md:flex-row items-center gap-8">
            <Link target="blank" href="https://www.linkedin.com/in/piyush-s-3a663092" className="inline-flex items-center gap-1.5">
              <span className="font-semibold">LinkedIn</span>
              <ArrowUpRightIcon className="size-4"/>
            </Link>
            <Link target="blank" href="mailto:piyushsaini034@gmail.com" className="inline-flex items-center gap-1.5">
