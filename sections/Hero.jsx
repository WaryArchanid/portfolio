"use client"
import memojiImage from '@/assets/images/sticker.png'
            ...
            <div className="container">
                <div className='flex flex-col items-center'>
                    ...
                    <div className='bg-gray-950 border border-gray-800 px-4 py-1.5 inline-flex items-center gap-4 rounded-lg'>
                        ...
                        <div className='text-sm font-medium font-sans'>Available for new projects</div>
                    </div>
                </div>
                ...
                <div className='flex flex-col items-center z-50  mt-8 gap-4 md:flex-row justify-center'>
                    ...
                    <Link href="https://drive.google.com/file/d/1xD8RfkSm6E4ifPXp9rOcGQII-df-BHJW/view" target='_blank'  className='inline-flex  z-50 cursor-pointer  items-center gap-2 border border-white/15 px-6 h-12 rounded-xl '>
